...
class Balloon:
    def __init__(self):
        ...
        self.images = [image.load("material/balloon/balloon.png", size=size, flip=moving_direction=="right")]
        self.current_frame = 0
        self.animation_timer = 0


    def define_pop_pos(self, size): # define the start pos and moving vel of the balloon
        vel = random.uniform(BALLOON_MOVE_SPEED["min"], BALLOON_MOVE_SPEED["max"])
    ...
    def animate(self): # change the frame of the balloon when needed
        t = time.time()
