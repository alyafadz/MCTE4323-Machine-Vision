...
BALLOON_SIZES = (50, 38)
BALLOON_SIZE_RANDOMIZE = (1,2) # for each new balloon, it will multiply the size with an random value beteewn X and Y
BUBBLE_SIZES = (50, 50)
...
BALLOON_POP_TIME = 1
BALLOON_MOVE_SPEED = {"min": 1, "max": 5}
BUBBLE_PENALITY = 1 # will remove X of the score of the player (if he pops a bubble)
